...
let username=localStorage.getItem('usernameSection')
if (username){
...
function signUp(){
    if (isEmpty()==false){
        document.getElementById('exist').innerHTML='<span class="text-danger m-3">All inputs is requierd</span>'
        return false
    }
...
// for logout
function logout() {
    localStorage.removeItem('usernameSection')
}
